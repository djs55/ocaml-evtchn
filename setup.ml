...
(* OASIS_START *)
(* DO NOT EDIT (digest: fbd9190841e6a93439d29ad304c71bfe) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Eventchn"; "Generation"; "S"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xen-evtchn";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "evtchn_inheap";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Inheap_events"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "evtchn";
                      lib_findlib_name = Some "inheap";
                      lib_findlib_containers = []
                   });
               Library
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Xen_events"; "Activations"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "evtchn";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Xenctrl_events"; "Unix_activations"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "evtchn";
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "evtchn";
                           InternalLibrary "evtchn_xenctrl"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "^J9Pz,\194-\227\207OK\225\164o\235";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
